...
<div class="art-header">
                    ...
                    <div class="art-header-jpeg">您好，欢迎来到Estore购物商城！<a href="login.jsp">[登录]</a> <a href="regist.jsp">[免费注册]</a></div>
                    <div class="art-logo">
                ...
                <div class="art-nav">
                	...
                	<ul class="art-menu">
                		...
                		<li>
                			<a href="#"><span class="l"></span><span class="r"></span><span class="t">热卖商品</span></a>
                			<ul>
								<li><a href="#">图书、电子书刊、音像</a></li>
                				<li><a href="#">电子数码</a>
                					<ul>
