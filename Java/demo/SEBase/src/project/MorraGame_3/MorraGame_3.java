...
package project.MorraGame_3;

import java.util.Scanner;

public class MorraGame_3 {
	int score = 0;  //分数
    String name = "";  //名字
    
    MorraGame_3(String name, int score) {
    	this.name = name;
        this.score = score;
    }
	...
	public static void main(String[] args) {
		...
		MorraGame_3[] t = new MorraGame_3[3];
        
//		int index=4;
		int userWin = 0;  //声明用户获得胜利的场数
		int computerWin = 0;  //声明计算机获得胜利的场数
		int num = 0;  //用户选择的游戏项
//		int[] score = {userWin,computerWin,3};
		...
		do{
			...
			switch(num){
				...
				case 1:
					...
					//统计赢的次数
					System.out.println("赢了:" + userWin + "次！");
...
//					score[index]=userWin;
					...
					t[0] = new MorraGame_3(user, userWin);
			        t[1] = new MorraGame_3(computer, computerWin);
			        t[2] = new MorraGame_3("cmcc", 10);
