...
package eg.tip.spiralMatrixAlgorithm1;
...
public class SpiralMatrixAlgorithm {
	...
	public static void main(String args[]) {
    	System.out.print("螺旋矩阵算法--请输入您要显示的行数：");
		SpiralMatrixAlgorithm my = new SpiralMatrixAlgorithm(new Scanner(System.in).nextInt());  //利用Scanner获取控制台输入
        my.snakeMatrix();
        my.print();
    }
}
